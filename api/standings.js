...
export default async function handler(req, res) {
  ...
  try {
    ...
    const [
      ...
      openf1Weather, openf1Session, winnersData
    ] = await Promise.all([
      ...
      fetchJson('https://api.jolpi.ca/ergast/f1/current/qualifying.json'), // THE FIX: Fetch ALL qualifying data
    ...
    // DECOUPLED QUALIFYING: Grab the absolute latest qualifying session array to fix mismatches
    let qualifying = null;
